    ...
    <section id='pricing-plan'>
        <div className="container">
            <div className="pricing__top">
                <h2 className="section__title">Gym <span className="highlights">Pricing</span></h2>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing <br /> elit. Eligendi nobis accusamus, molestiae a officia sunt.</p>
            </div>
            ...
            <div className="pricing__wrapper">
                ...
                <div className="pricing__item pricing__item-02" data-aos="fade-up" data-aos-duration="1800">
                    <div className="pricing__card-top">
                        ...
                        <h2 className="pricing">$80 <span>/month</span></h2>
                    </div>
